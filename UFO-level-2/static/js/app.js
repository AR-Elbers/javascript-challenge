...
function listchange(selectObject) {
    ...
    else if(val == 'date')
    {
        ...
        document.getElementById('userinput').placeholder='01/01/2010';
    }
    else if(val == "state")
    {
        listcontrol.text("Select a State");
        document.getElementById('userinput').placeholder='ar';
    }
    else if(val == "country")
    {
    ...
    else if(val == "shape")
    {
        ...
        document.getElementById('userinput').placeholder='circle';
    };
